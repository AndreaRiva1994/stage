...
#include "../lib/sdsl-lite/include/sdsl/construct.hpp"
...
// \log n backward search on the psi function
tCST::size_type backward_search_(
				 const tCST::csa_type &csa, 	
...
tCST::size_type backward_search(
				const tCST::csa_type &csa,
				const unsigned char c,
				tCST::size_type &lb,
				tCST::size_type &rb){
...
void report_maximal_exact_match(const tCST &cst1, const unsigned char *s2, size_type c_, size_type p2_, size_type k, bool _4column, const vector<string> &refdescr, const vector<long> &startpos, long maxdescrlen, tCST::size_type p2_offset=0){
  size_type sa_k = cst1.csa[k];
  if( p2_ == 0){
    print_maximal_exact_match(sa_k, p2_+p2_offset, c_, _4column, refdescr, startpos, maxdescrlen);
  }else{ // p2_ > 0
    size_type lf_k = cst1.csa.psi[k];
 ...
 */
void maximal_exact_matches(const tCST &cst1, const unsigned char *s2, tCST::size_type n2, tCST::size_type l, bool _4column, const vector<string> &refdescr, const vector<long> &startpos, long maxdescrlen, tCST::size_type p2_offset=0){
...
void anwer_query(const string &query_fasta, const tCST &cst1, tCST::size_type min_len, const vector<string> &refdescr, const vector<long> &startpos, long maxdescrlen, 
		 bool rev_comp,
		 bool _4column,
